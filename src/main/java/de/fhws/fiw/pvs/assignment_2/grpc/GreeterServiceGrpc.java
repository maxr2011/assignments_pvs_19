...
public final class GreeterServiceGrpc
{
	...
	public static final io.grpc.MethodDescriptor<de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Request,
		de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Reply> METHOD_GET_GREETING =
		io.grpc.MethodDescriptor.create(
			io.grpc.MethodDescriptor.MethodType.UNARY,
			generateFullMethodName(
				"de.fhws.fiw.pvs.grpc.GreeterService", "getGreeting" ),
			io.grpc.protobuf.ProtoUtils.marshaller( de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Request.getDefaultInstance( ) ),
			io.grpc.protobuf.ProtoUtils.marshaller( de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Reply.getDefaultInstance( ) ) );
	@io.grpc.ExperimentalApi( "https://github.com/grpc/grpc-java/issues/1901" )
	public static final io.grpc.MethodDescriptor<de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Request,
		de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Reply> METHOD_GET_ANOTHER_GREETING =
		io.grpc.MethodDescriptor.create(
			io.grpc.MethodDescriptor.MethodType.UNARY,
			generateFullMethodName(
	...
	public static abstract class GreeterServiceImplBase implements io.grpc.BindableService
	{
		 ...
		 *
		 */
		public void getGreeting( de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Request request,
			io.grpc.stub.StreamObserver<de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Reply> responseObserver )
		{
		 ...
		 *
		 */
		public void getAnotherGreeting( de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Request request,
			io.grpc.stub.StreamObserver<de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Reply> responseObserver )
		{
		...
		@java.lang.Override public final io.grpc.ServerServiceDefinition bindService( )
		{
			return io.grpc.ServerServiceDefinition.builder( getServiceDescriptor( ) )
												  .addMethod(
													  ...
													  asyncUnaryCall(
														  new MethodHandlers<
															  de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Request,
															  de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Reply>(
	...
	public static final class GreeterServiceBlockingStub extends io.grpc.stub.AbstractStub<GreeterServiceBlockingStub>
	{
		 ...
		 *
		 */
		public de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Reply getGreeting(
			de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Request request )
		{
		 ...
		 *
		 */
		public de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Reply getAnotherGreeting(
			de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Request request )
		{
			return blockingUnaryCall(
	...
	public static final class GreeterServiceFutureStub extends io.grpc.stub.AbstractStub<GreeterServiceFutureStub>
	{
		 ...
		 *
		 */
		public com.google.common.util.concurrent.ListenableFuture<de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Reply> getGreeting(
			de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Request request )
		{
		 ...
		 *
		 */
		public com.google.common.util.concurrent.ListenableFuture<de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Reply> getAnotherGreeting(
			de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Request request )
		{
			return futureUnaryCall(
		...
		io.grpc.stub.ServerCalls.BidiStreamingMethod<Req, Resp>
	{
		...
		public void invoke( Req request, io.grpc.stub.StreamObserver<Resp> responseObserver )
		{
			...
			case METHODID_GET_GREETING:
				serviceImpl.getGreeting( ( de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Request ) request,
					( io.grpc.stub.StreamObserver<de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Reply> ) responseObserver );
				break;
			case METHODID_GET_ANOTHER_GREETING:
				serviceImpl.getAnotherGreeting( ( de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Request ) request,
					( io.grpc.stub.StreamObserver<de.fhws.fiw.pvs.assignment_2.grpc.Greeter.Reply> ) responseObserver );
				break;
			default:
	...
	private static final class GreeterServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier
	{
		...
		{
			return de.fhws.fiw.pvs.assignment_2.grpc.Greeter.getDescriptor( );
		}
	}
			...
			synchronized ( GreeterServiceGrpc.class )
			{
				...
				if ( result == null )
				{
					serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder( SERVICE_NAME )
																		  .setSchemaDescriptor(
																			  new GreeterServiceDescriptorSupplier( ) )
