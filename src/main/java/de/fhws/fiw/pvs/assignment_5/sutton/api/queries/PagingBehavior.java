...
public interface PagingBehavior<T extends AbstractModel>
{
	...
	void addNextPageLink(PagingContext pagingContext, CollectionModelResult<?> result);

	void addPageHeader(PagingContext pagingContext, CollectionModelResult<?> result);
